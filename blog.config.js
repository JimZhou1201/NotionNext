...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AI Library', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的测试🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ailibrary.vip', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI Library', // 网站关键词 英文逗号隔开
